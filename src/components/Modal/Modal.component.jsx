...
import useStyles from './model.styles.js';
...
const Modal = ({ isOpen, setIsOpen, showFeedback }) => {
  ...
  if (isOpen && showFeedback) {
    ...
    body = (
      <div className={classes.paper}>
        <Typography variant='h4' className="con-font">Instructions</Typography>
        <Divider />
        <div className={classes.infoContainer}>
          <Typography variant='h6' className="con-font">News by Categories</Typography>
        ...
        <Divider />
        <div className={classes.infoContainer}>
          <Typography variant='h6'  className="con-font">News by Terms</Typography>
          <div className={classes.chipContainer}>
        ...
        <Divider />
        <div className={classes.infoContainer}>
          <Typography variant='h6'  className="con-font">News by Sources</Typography>
          <div className={classes.chipContainer}>
            {[
              'CNN',
              'Wired',
